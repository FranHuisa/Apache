 ...
 *
 * Igual que [com.apache.memory.MemoryService], concentra la validación y
 * las reglas de negocio; el Repository solo sabe hablar con Exposed/MySQL.
 */
@Service
class CalendarService(
    ...
    fun getEvents(
        ...
        return calendarRepository.findEventsBetween(
            calendarId,
            from,
            to
        )
    ...
    fun getEvent(eventId: Long): CalendarEventRecord? =
        calendarRepository.findEventById(eventId)
    ...
    fun updateEvent(
        ...
        require(existingEvent != null) {
            "El evento con id=$eventId no existe."
        }
    ...
    fun deleteEvent(eventId: Long): Boolean =
        calendarRepository.cancelEvent(eventId)
}
